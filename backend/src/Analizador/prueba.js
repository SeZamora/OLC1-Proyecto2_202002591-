...
myDatabase.createTable('users', { id: "int", nombre: "varchar", email: "varchar", age: "int" });

myDatabase.insertIntoTable("users", {
  id: 1,
  nombre: "John",
...
function parseCondition(conditionString) {
  // Define la función de condición que toma una fila como argumento
